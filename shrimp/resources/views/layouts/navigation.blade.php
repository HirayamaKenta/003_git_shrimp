      ...
      <div class="flex">
        ...
        <div class="shrink-0 flex items-center">
          <a href="{{ route('top') }}">
            ...
            w-auto fill-current text-gray-600" /> --}}
<img src="{{asset('logo/shrimp.png')}}" style="max-height:50px;">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          <x-nav-link :href="route('chat.create')" :active="request()->routeIs('post.create')">
            HOME
          </x-nav-link>
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-slate-200">
    <div class="pt-2 pb-3 space-y-1 ">
      <x-responsive-nav-link :href="route('chat.create')" :active="request()->routeIs('post.create')">
        HOME
